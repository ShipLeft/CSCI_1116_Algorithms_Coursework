...
/**
 * <h1>TwoWayLinkedList</h1>
 *
 * <p>This class is the constructor for a two way linked list that will allow for looking forward
 * as well as backward compared to the one way list only looking forward.</p>
 *
 * <p>Edited: 12/15/21</p>
 *
 * @author Unknown, Rhett Boatright
 *
 * @param <E> (Generic variable; allows for the list to be gathered from the main method)
 */
